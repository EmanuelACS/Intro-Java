...
public class War {
    ...
    /**
     * The warResult method outputs to console the current 
     * cards being in play, and the winner of each hand.
     * 
     * @param computerCard AI's card
     * @param humanCard User's card
     * @param results returns the results array to keep count of wins
     */
    public int[] warResult(Card computerCard, Card humanCard, int[] results) {
    ...
    public static void main(String[] args) {
        ...
        int[] results = {0,0,0}; // contains outcome of the game 
        war1.warResult(computerCard, humanCard, results);
    }
}
