...
/**
 * War2 Class, a class that implements discarding in 
 * case of ties during the comparing of cards
 *
...
public class War2 {
	...
	public static void main(String[] args) {
        ...
        int[] results = {0,0,0}; // contains full results of the outcome of all games
        war2.warResult(computerCard, humanCard, results);
